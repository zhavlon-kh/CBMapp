...
<head>
    <meta charset="utf-8">
    <title>Contacts Book Management System</title>
...
<header id="header">
    <div class="container">
        ...
        <div id="logo" class="pull-left">
            <a href="#hero"><img src="templates/img/logo.png" alt="" title="" /></img></a>
            <!-- Uncomment below if you prefer to use a text logo -->
            <h1><a href="#hero">CBMS</a></h1>
        </div>
...
<section id="hero">
    <div class="hero-container">
        ...
        <h2>We are team of talanted developers</h2>
    </div>
</section><!-- #hero -->
...
<footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong>CBMS</strong>. All Rights Reserved
        </div>
